"""Main entry point: PySpark Structured Streaming CDC consumer.

Reads Debezium CDC events from Kafka and writes to Delta Lake
with upsert/delete semantics using foreachBatch + MERGE.
"""
...
def create_spark_session() -> SparkSession:
    """Create a SparkSession configured for Delta Lake and Kafka."""
    return (
        SparkSession.builder
        .appName("CDC-Delta-Consumer")
        .master("local[*]")
        .config(
...
def main():
    logger.info("Starting CDC consumer pipeline...")
